...
from src.parser_cian.settings import HEADERS_PARSER, HEADERS
    ...
    for i in range(1, pages):
        try:
            if i == 1:
                ...
                url_pages = (f'https://krasnoyarsk.cian.ru/cat.php?deal_type'
                             f'=rent&engine_version=2&offer_type=flat&p={i}&'
                             'region=4827&type=4')
            parsing_page = ParsingPage(url_pages, headers=HEADERS)
